...
Kalman_SLAM::Kalman_SLAM( unsigned location_size, Full_filter& filter_generator ) :
	SLAM(),
	full(filter_generator.generate(location_size)),
	fgenerator(filter_generator), nL(location_size)
{
	nM = 0;
}
