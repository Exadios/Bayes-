...
class Boost_random : public Bayesian_filter_test::Boost_random, public SIR_random
/*
 ...
 */
class PVobserve : public General_LzUnAd_observe_model
{
	mutable Vec z_pred;
public:
	PVobserve ();
...
PVobserve::PVobserve () :
	General_LzUnAd_observe_model(NX,1), z_pred(1)
{
	// Linear model
	Hx(0,0) = 1;
	Hx(0,1) = 0.;
